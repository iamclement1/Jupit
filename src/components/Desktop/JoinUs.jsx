...
const JoinUs = () => {
    return (
        <>
            <img src={btc} alt="btc-image" className='relative w-[90px] inset-x-3/4 top-12 ' />
            ...
            <img src={naira} alt="naira--currency--log" className='absolute w-[90px] right-48   ' />
                <div className=" w-full flex flex-col justify-center">
                    <h1 className="text-white text-center text-xl w-3/5 m-auto font-semibold font-poppins">
