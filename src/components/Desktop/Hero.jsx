...
const Hero = () => {
    return (
        <>
            <section>
                <div className="md:hidden lg:hidden xl:block 2xl:block">
                ...
                <div className="md:block lg:block xl:hidden">
                    <main className="flex justify-between mb-8">
                        <div className="md:w-2/4 mx-auto text-center leading-6">
                            <h1 className="md:text-2xl lg:text-4xl font-bold md:w-4/4 lg:w-5/5 text-[#040415] leading-relaxed md:mt-10 ">
                                Make easy digital assets transactions anywhere, anytime with Jupit.
                            </h1>
                            <p className="md:text-xs lg:text-sm md:w-6/6 lg:w-5/5 md:py-3 lg:py-3 lg:px-12">
                                A place for everyone who wants to simply buy and sell digital assets, it just takes 120 seconds.
                            </p>
                            <button className='bg-[#ffa000] text-blue-900 font-bold py-3 px-6 mt-3 rounded cursor-pointer'>
                                Get Started
